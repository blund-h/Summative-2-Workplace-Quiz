    ...
    def build_name_screen(self):
        ...
        tk.Label(
            ...
            text="Welcome to the SUN R&D PMO Quiz!\n\n"
                 "This quiz is designed to test your knowledge on the tools, procedures and common practices that the SUN R&D PMO Team has established.\n\n"
                 "The quiz consists of multiple choice questions that you must answer, and submit. At the end of the quiz you will receive your score which will be stored in a results.csv file.\n\n"
                 "Good Luck!",
            font=("Arial", 14),
            bg=self.atlas_blue_colour,
            fg=self.white_colour,
